...
public class Write extends Activity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		Button btnWrite1 = (Button) findViewById(R.id.button2);
		...
		btnWrite1.setOnClickListener(new OnClickListener() {
			
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent myintent=new Intent(Write.this, ListViewAndroidExample.class);
